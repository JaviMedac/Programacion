...
public class ControladorPreguntas {
    ...
    public ArrayList<PreguntasDeportes> ObtenerTodasDatosDeportes() throws SQLException {
    ...
    public ArrayList<PreguntasVideojuegos> ObtenerTodosDatosVideojuegos() throws SQLException {
